                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                     ...
                     <span> Saturday and Sunday: 12:00 PM - 5:00 PM</span>
                    </p>
                  </div>
                </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-gray-50 p-6 md:p-10 rounded-xl border border-gray-100">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-7 py-3 rounded-md transition"
                  >
                    Send Message
                    <Send size={18} />
                  </button>
